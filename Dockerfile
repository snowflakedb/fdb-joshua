...
RUN if [ "$(uname -p)" == "x86_64" ]; then \
        ...
        # commented this out because we (snowflake) copy our own libfdb_c.so from s3
        # see https://github.com/snowflakedb/jenkins_utils/pull/2637
